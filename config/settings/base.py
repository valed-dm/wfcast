...
MIGRATION_MODULES = {"sites": "wfcast.contrib.sites.migrations"}
...
ACCOUNT_FORMS = {"signup": "wfcast.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "wfcast.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "wfcast.users.forms.UserSocialSignupForm"}
